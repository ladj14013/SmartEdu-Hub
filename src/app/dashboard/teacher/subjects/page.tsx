      ...
      return (
        <div className="space-y-6">
          ...
          <div className="space-y-8">
            <Card>
              <CardHeader><Skeleton className="h-7 w-48 mb-3" /></CardHeader>
              <CardContent><div className="divide-y"><Skeleton className="h-14 w-full" /><Skeleton className="h-14 w-full" /></div></CardContent>
            </Card>
            <Card>
              <CardHeader><Skeleton className="h-7 w-48 mb-3" /></CardHeader>
              <CardContent><div className="divide-y"><Skeleton className="h-14 w-full" /></div></CardContent>
            </Card>
          </div>
        </div>
      );
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-8">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>الدروس العامة المتاحة</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="divide-y rounded-md border">
